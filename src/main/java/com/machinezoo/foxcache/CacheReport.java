                ...
                new RunnablePicker("Cache view")
                    ...
                    .add("Progress", () -> {
                        ...
                        for (var entry : running) {
                             ...
                             */
                            ReactiveInstant.now().plus(Duration.of(ConsistentRandom.of(fragment.elementId()).nextInt(1000), ChronoUnit.MILLIS))
                            ...
                            detailsPicker
                                ...
                                .add("Contents", () -> {
                                    if (details.snapshot != null) {
                                        ...
                                        StaticContent.show("Size", Pretty.bytes().format(snapshot.size()));
                                ...
                                .add("Exception", () -> {
                                    if (details.input.exception() != null)
                                        SiteFragment.get()
                                            .add(Html.pre().clazz("site-error").add(new CachedException(details.input.exception()).getFormattedCause()));
